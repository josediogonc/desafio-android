...
object Libs {
    ...
    const val MATERIAL_DESIGN = "com.google.android.material:material:${Versioning.MATERIAL_VERSION}"
    ...
    const val CIRCLE_IMAGEVIEW = "de.hdodenhof:circleimageview:${Versioning.CIRCLE_IMAGEVIEW_VERSION}"
